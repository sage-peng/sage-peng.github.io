...
![二分图 -w150](../../img/assets/2024-09-19_junior/55289_ac17cbdcae-二分图.png)

-   下图不是个二分图：

![1.png](../../img/assets/2024-09-19_junior/55289_d09603aaae-1.png)
...
- 方法： [参考](https://www.cnblogs.com/dx123/p/16418297.html)
  ...
  - 增广路:
    ...
    匹配点，则这条交替路称为增广路
    例如，3→5→1→4→2→7![image-20241022110612696](../../img/assets/2024-09-19_junior/image-20241022110612696.png)
